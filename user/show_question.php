...
if (isset($_GET['id'])){
    $quiz_id=$_GET['id'];
    $user_id=$_SESSION['user_id'];
    $_SESSION['start']=$quiz_id;

    $q_get_question_details = "SELECT * FROM `question` 
    WHERE `quiz_id`='$quiz_id' AND `is_expired`=0 ORDER BY `sequence` ASC";
...
?>
<body data-new-gr-c-s-check-loaded="14.1087.0" data-gr-ext-installed="" onload="timeout()">
    <div class="wrapper position-relative">
        <div class="container-fluid px-5">
            ...
            <div class="text-end" id="response"> 
                <h5 class="text-black d-inline-block" id="time" name='time'></h5>
            </div>
            ...
            ?>
                ...
                <div class="multisteps_form_panel active slideVert" data-animation="slideVert">
                    <div class="form_content">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form_title ps-5" id="load_question">
                                    <input type='hidden' name='sequence' value='<?php echo $row_q_question["sequence"]?>'>
                        ...
                        ?>                        
                            <input class="js-btn-next f_btn rounded-pill active text-uppercase" type="submit" value="Submit" name="submit" />
                        <?php
                        }
                        ?>
                        </div>
